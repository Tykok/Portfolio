    ...
    <g>
      <defs>
        <linearGradient id="ic-pc-body" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset=".5" stopColor="#d9d6c8" />
          <stop offset="1" stopColor="#a7a290" />
        </linearGradient>
        <linearGradient id="ic-pc-scr" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#a9d2ff" />
          <stop offset=".45" stopColor="#3f7fe6" />
          <stop offset="1" stopColor="#0b337f" />
        </linearGradient>
        <linearGradient id="ic-pc-base" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#eceadd" />
          <stop offset="1" stopColor="#9c9784" />
        </linearGradient>
      </defs>
    ...
    <g>
      <defs>
        <linearGradient id="ic-fold-back" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="1" stopColor="#e9a81f" />
        </linearGradient>
        <linearGradient id="ic-fold-front" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#ffe7a0" />
          <stop offset=".5" stopColor="#ffc94d" />
          <stop offset="1" stopColor="#f0a81c" />
        </linearGradient>
      </defs>
      <ellipse cx="24" cy="40.5" rx="16" ry="2.4" fill="#000" opacity=".12" />
      <path
        d="M6 13.5c0-1.4 1-2.4 2.4-2.4h9.2l3 3.2h14c1.3 0 2.4 1 2.4 2.4v17.7H6z"
        fill="url(#ic-fold-back)"
        stroke="#c98e12"
        strokeWidth=".8"
      />
      <rect x="11" y="15.8" width="26" height="13" rx="1.4" fill="#fbfbf6" stroke="#d8d2bd" strokeWidth=".6" />
      <path
        d="M6.4 22.5h31l4.2 0c1.4 0 2.4 1.3 2.1 2.6l-2.4 9.3c-.3 1.1-1.2 1.8-2.3 1.8H4.5c-1.4 0-2.4-1.3-2.1-2.7l3.9-9.2c.3-1 .1-1.8 .1-1.8z"
        fill="url(#ic-fold-front)"
        stroke="#cf950f"
        strokeWidth=".8"
      />
    ...
    <g>
      <defs>
        ...
        <linearGradient id="ic-doc-hdr" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0" stopColor="#5b9bee" />
          <stop offset="1" stopColor="#1a52d6" />
        </linearGradient>
      </defs>
    ...
    <g>
      <defs>
        <linearGradient id="ic-mail-bg" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0" stopColor="#ffffff" />
          <stop offset="1" stopColor="#cfe0fb" />
        </linearGradient>
      ...
      <path
        d="M4.6 35.6 L19 24 h10 L43.4 35.6 V35c0 1.4-1 2.4-2.4 2.4H7c-1.4 0-2.4-1-2.4-2.4z"
        fill="#e3edfd"
        stroke="#9bb6e4"
        strokeWidth=".5"
      />
  ...
  term: (
    <g>
      ...
      <g fill="#fff" opacity=".85">
        <circle cx="36" cy="11.5" r="1.1" />
        <circle cx="39.4" cy="11.5" r="1.1" />
      </g>
      <text x="10" y="29" fontFamily="'Lucida Console',monospace" fontSize="11" fontWeight="700" fill="#54e054">
        &gt;_
      </text>
    </g>
  ),
    ...
    <g>
      <defs>
        <radialGradient id="ic-globe-b" cx=".36" cy=".3" r=".8">
          ...
          <stop offset=".42" stopColor="#4fa3e8" />
          <stop offset=".8" stopColor="#1763b0" />
          <stop offset="1" stopColor="#0b3d7c" />
        </radialGradient>
        <clipPath id="ic-globe-clip">
          <circle cx="24" cy="23" r="17" />
        </clipPath>
      </defs>
